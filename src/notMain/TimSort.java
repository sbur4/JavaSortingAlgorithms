 ...
 * It was designed to perform in an optimal way on different kind of real world data.
 * It is an adaptive sorting algorithm which needs O(n log n) comparisons to sort an array of n elements.
 */
